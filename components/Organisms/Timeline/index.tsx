      ...
      <Container className="py-20">
        ...
        {/* <div className="lg:grid lg:grid-cols-[45%_5%_45%] flex lg:gap-10 gap-2 items-start lg:items-end mb-8">
          <div className="flex flex-col items-start lg:items-end lg:gap-2 lg:order-1 order-2">
            ...
            <p className="leading-7 lg:leading-7 lg:leading-7 lg:leading-7 lg:text-sm text-xs lg:text-right text-start">
          ...
          <div className="items-end hidden lg:flex lg:order-3">
            <p className="text-primary text-lg font-bold">November 18, 2023</p>
          </div>
        </div>
        <div className="lg:grid lg:grid-cols-[45%_5%_45%] flex lg:gap-10 gap-2 items-start lg:items-end mb-8">
          ...
          <div className="flex flex-col items-start lg:gap-2 lg:order-3 order-2">
            ...
            <p className="text-xs leading-7 lg:leading-7 lg:leading-7 lg:leading-7 lg:text-sm">
        ...
        <div className="lg:grid lg:grid-cols-[45%_5%_45%] flex lg:gap-10 gap-2 items-start lg:items-end mb-8">
          <div className="flex flex-col items-start lg:items-end lg:gap-2 lg:order-1 order-2">
            ...
            <p className="lg:text-right text-start leading-7 lg:leading-7 lg:leading-7 lg:leading-7 lg:text-sm text-xs">
        ...
        <div className="lg:grid lg:grid-cols-[45%_5%_45%] flex lg:gap-10 gap-2 items-start lg:items-end mb-8">
          ...
          <div className="flex flex-col items-start lg:gap-2 lg:order-3 order-2">
            ...
            <p className="leading-7 lg:leading-7 lg:leading-7 lg:leading-7 lg:text-sm text-xs">
